...
" Main Colors
hi Normal             guibg=#232323 ctermbg=232   guifg=#FFFFFF ctermfg=15  gui=none
...
hi Boolean            guifg=#ff44cc ctermfg=206  cterm=bold                 gui=none
hi Constant           guifg=#fce94f ctermfg=221                              gui=none
hi Number             guifg=#00c99b ctermfg=43                              gui=none
hi Statement          guifg=#FF9900 ctermfg=208                             gui=none
hi Character          guifg=#FF9900 ctermfg=208                             gui=none
hi Comment            guifg=#bb66ff ctermfg=135  cterm=italic               gui=none
